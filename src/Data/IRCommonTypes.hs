...
newtype TrueOrFalse = TrueOrFalse Xs.Boolean deriving (Eq,Show)
instance Restricts TrueOrFalse Xs.Boolean where
...
newtype Decimal2 = Decimal2 Xs.Decimal deriving (Eq,Show)
instance Restricts Decimal2 Xs.Decimal where
...
newtype String2 = String2 Xs.XsdString deriving (Eq,Show)
instance Restricts String2 Xs.XsdString where
...
newtype String4000 = String4000 Xs.XsdString deriving (Eq,Show)
instance Restricts String4000 Xs.XsdString where
