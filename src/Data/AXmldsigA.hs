...
data TransformType = TransformType
      ...
      --    ,transfType_choice0 :: [OneOf2 {- String -} Xsd.XsdString (AnyElement)]
...
data KeyInfoType = KeyInfoType
 ...
 --       , keyInfoType_choice0 :: [OneOf9 String Xsd.XsdString KeyValueType RetrievalMethodType X509DataType PGPDataType SPKIDataType Xsd.XsdString (AnyElement)]
        , keyInfoType_choice0 :: [OneOf1 X509DataType]
...
instance SchemaType KeyInfoType where
    parseSchemaType s = do
        ...
        commit $ interior e $ return (KeyInfoType a0)
            --`apply` many1 elementX509Data
            `apply` many1 (oneOf' [("X509DataType", fmap OneOf1 (elementX509Data))])                   
...
data X509DataType = X509DataType
        { x509DataType_choice0 :: [OneOf5 X509IssuerSerialType Base64Binary Xsd.XsdString Base64Binary Base64Binary {- (AnyElement) -}]
          -- ^ Choice between:
          --   
          --   (1) X509IssuerSerial
          --   
...
instance SchemaType X509DataType where
    parseSchemaType s = do
        ...
        commit $ interior e $ return X509DataType                          
            `apply` many1 (oneOf' [ ("X509IssuerSerialType", fmap OneOf5 (parseSchemaType "X509IssuerSerial"))
                           , ("Base64Binary", fmap TwoOf5 (parseSchemaType "X509SKI"))
                           , ("Xsd.XsdString", fmap ThreeOf5 (parseSchemaType "X509SubjectName"))
                           , ("Base64Binary", fmap FourOf5 (parseSchemaType "X509Certificate"))
                           , ("Base64Binary", fmap FiveOf5 (parseSchemaType "X509CRL"))
  --                         , ("AnyElement", fmap SixOf6 (parseAnyElement))
                           ])
                            
    schemaTypeToXML s x@X509DataType{} =
        toXMLElement s [] [
            foldl (\acc item-> case item of
                OneOf5 d-> acc++(schemaTypeToXML "X509Certificate" d)            
                TwoOf5 d-> acc++(schemaTypeToXML "X509Certificate" d)            
                ThreeOf5 d-> acc++(schemaTypeToXML "X509Certificate" d)
                FourOf5 d-> acc++(schemaTypeToXML "X509Certificate" d)
                FiveOf5 d-> acc++(schemaTypeToXML "X509Certificate" d)
