...
module Data.WageReportsFromIRTypes'xsd
  ( module Data.WageReportsFromIRTypes'xsd
  ) where
...
data Absence = Absence
        { absence_repStartDate :: Maybe Xsd.Date
        , absence_repEndDate :: Maybe Xsd.Date
...
data CarBenefit = CarBenefit
        { carBenefit_code :: Maybe Xs.Int
        , carBenefit_ageGroupCode :: Maybe Xs.Int
...
instance SchemaType CarBenefit where
    parseSchemaType s = do
        ...
        commit $ interior e $ return CarBenefit
            `apply` optional (parseSchemaType "CarBenefitCode")
            `apply` optional (parseSchemaType "AgeGroupCode")
            `apply` optional (parseSchemaType "Kilometers")
            `apply` optional (parseSchemaType "EmissionsValue")
    schemaTypeToXML s x@CarBenefit{} =
        toXMLElement s []
            [ maybe [] (schemaTypeToXML "CarBenefitCode") $ carBenefit_code x
            , maybe [] (schemaTypeToXML "AgeGroupCode") $ carBenefit_ageGroupCode x
...
data EmploymentEnding = EmploymentEnding
        { emploEnding_type :: Maybe Xs.Int
        , emploEnding_code :: Maybe Irct.String20
        }
        deriving (Eq,Show)
instance SchemaType EmploymentEnding where
    ...
    schemaTypeToXML s x@EmploymentEnding{} =
        toXMLElement s []
            [ maybe [] (schemaTypeToXML "Type") $ emploEnding_type x
            , maybe [] (schemaTypeToXML "Code") $ emploEnding_code x
            ]
...
data EmploymentReg = EmploymentReg
        { emploReg_type :: Maybe Xs.Int
        , emploReg_code :: Maybe Irct.String20
        }
        deriving (Eq,Show)
instance SchemaType EmploymentReg where
    ...
    schemaTypeToXML s x@EmploymentReg{} =
        toXMLElement s []
            [ maybe [] (schemaTypeToXML "Type") $ emploReg_type x
            , maybe [] (schemaTypeToXML "Code") $ emploReg_code x
            ]
...
data IncomeEarnerOther = IncomeEarnerOther
        { incomeEarnerOther_sensitiveInfoIncluded :: Maybe Irct.True
...
instance SchemaType IncomeEarnerOther where
    ...
    schemaTypeToXML s x@IncomeEarnerOther{} =
        toXMLElement s []
            [ maybe [] (schemaTypeToXML "SensitiveInfoIncluded") $ incomeEarnerOther_sensitiveInfoIncluded x
...
data OrigPaymentPeriod = OrigPaymentPeriod
        { origPaymentPeriod_paymentDate :: Maybe Xsd.Date
        , origPaymentPeriod_startDate :: Maybe Xsd.Date
        , origPaymentPeriod_endDate :: Maybe Xsd.Date
        }
        deriving (Eq,Show)
instance SchemaType OrigPaymentPeriod where
    ...
    schemaTypeToXML s x@OrigPaymentPeriod{} =
        toXMLElement s []
            ...
            , maybe [] (schemaTypeToXML "StartDate") $ origPaymentPeriod_startDate x
            , maybe [] (schemaTypeToXML "EndDate") $ origPaymentPeriod_endDate x
            ]
...
data PaidAbsencePeriod = PaidAbsencePeriod
        { paidAbsencePeriod_startDate :: Maybe Xsd.Date
        , paidAbsencePeriod_endDate :: Maybe Xsd.Date
        , paidAbsencePeriod_absenceDays :: Maybe Xs.Int
        , paidAbsencePeriod_absenceUntil :: Maybe Xsd.Date
        , paidAbsencePeriod_causeCode :: Maybe Xs.Int
        , paidAbsencePeriod_amount :: Maybe Irct.Decimal2
...
instance SchemaType PaidAbsencePeriod where
    parseSchemaType s = do
        ...
        commit $ interior e $ return PaidAbsencePeriod
            ...
            `apply` optional (parseSchemaType "CauseCode")
    ...
    schemaTypeToXML s x@PaidAbsencePeriod{} =
        toXMLElement s []
            [ maybe [] (schemaTypeToXML "StartDate") $ paidAbsencePeriod_startDate x
            ...
            , maybe [] (schemaTypeToXML "CauseCode") $ paidAbsencePeriod_causeCode x
            , maybe [] (schemaTypeToXML "Amount") $ paidAbsencePeriod_amount x
...
data PaymentPeriod = PaymentPeriod
        { paymentPeriod_paymentDate :: Xsd.Date
        , paymentPeriod_startDate :: Xsd.Date
        , paymentPeriod_endDate :: Xsd.Date
        }
        deriving (Eq,Show)
...
data PensionInsurance = PensionInsurance
        { pensionInsur_pensionActCode :: Maybe Xs.Int
...
instance SchemaType PensionInsurance where
    parseSchemaType s = do
        ...
        commit $ interior e $ return PensionInsurance
            `apply` optional (parseSchemaType "PensionActCode")
    ...
    schemaTypeToXML s x@PensionInsurance{} =
        toXMLElement s []
            [ maybe [] (schemaTypeToXML "PensionActCode") $ pensionInsur_pensionActCode x
...
data Period = Period
        { period_startDate :: Maybe Xsd.Date
        , period_endDate :: Maybe Xsd.Date
        }
        deriving (Eq,Show)
instance SchemaType Period where
    ...
    schemaTypeToXML s x@Period{} =
        toXMLElement s []
            [ maybe [] (schemaTypeToXML "StartDate") $ period_startDate x
...
data Profession = Profession
        { profession_type :: Maybe Xs.Int
        , profession_code :: Maybe Irct.String20
...
instance SchemaType Profession where
    ...
    schemaTypeToXML s x@Profession{} =
        toXMLElement s []
            [ maybe [] (schemaTypeToXML "Type") $ profession_type x
            , maybe [] (schemaTypeToXML "Code") $ profession_code x
...
data RecoveryData = RecoveryData
        ...
        , recoveryData_origPaymentPeriods :: Maybe OrigPaymentPeriods
        }
        deriving (Eq,Show)
instance SchemaType RecoveryData where
    parseSchemaType s = do
        ...
        commit $ interior e $ return RecoveryData
            ...
            `apply` optional (parseSchemaType "OrigPaymentPeriods")
    schemaTypeToXML s x@RecoveryData{} =
        toXMLElement s []
            ...
            , maybe [] (schemaTypeToXML "OrigPaymentPeriods") $ recoveryData_origPaymentPeriods x
            ]
...
data ReimbPayment = ReimbPayment
        { reimbPayment_paymentType :: Maybe Xs.Int
...
instance SchemaType ReimbPayment where
    ...
    schemaTypeToXML s x@ReimbPayment{} =
        toXMLElement s []
            [ maybe [] (schemaTypeToXML "PaymentType") $ reimbPayment_paymentType x
...
data Representative = Representative
        { repres_sensitiveInfoIncluded :: Maybe Irct.True
        , repres_ids :: Maybe RepresentativeIds
        , repres_name :: Maybe Irct.String200
...
instance SchemaType Representative where
    parseSchemaType s = do
        ...
        commit $ interior e $ return Representative
            `apply` optional (parseSchemaType "SensitiveInfoIncluded")
            `apply` optional (parseSchemaType "RepresentativeIds")
            `apply` optional (parseSchemaType "Name")
            `apply` optional (parseSchemaType "Address")
            `apply` optional (parseSchemaType "RepresentativeReports")
    schemaTypeToXML s x@Representative{} =
        toXMLElement s []
            [ maybe [] (schemaTypeToXML "SensitiveInfoIncluded") $ repres_sensitiveInfoIncluded x
            , maybe [] (schemaTypeToXML "RepresentativeIds") $ repres_ids x
            , maybe [] (schemaTypeToXML "Name") $ repres_name x
...
instance SchemaType SailorIncome where
    ...
    schemaTypeToXML s x@SailorIncome{} =
        toXMLElement s []
            [ maybe [] (schemaTypeToXML "SailorIncome") $ sailorIncome x
...
data ServiceRecipient = ServiceRecipient
        { serviceRecip_sensitiveInfoIncluded :: Maybe Irct.True
        , serviceRecip_ids :: Maybe ServiceRecipientIds
        , serviceRecip_name :: Maybe Irct.String200
...
instance SchemaType ServiceRecipient where
    parseSchemaType s = do
        ...
        commit $ interior e $ return ServiceRecipient
            `apply` optional (parseSchemaType "SensitiveInfoIncluded")
            `apply` optional (parseSchemaType "ServiceRecipientIds")
            `apply` optional (parseSchemaType "Name")
            `apply` optional (parseSchemaType "ServiceRecipientAddress")
    schemaTypeToXML s x@ServiceRecipient{} =
        toXMLElement s []
            [ maybe [] (schemaTypeToXML "SensitiveInfoIncluded") $ serviceRecip_sensitiveInfoIncluded x
            , maybe [] (schemaTypeToXML "ServiceRecipientIds") $ serviceRecip_ids x
            , maybe [] (schemaTypeToXML "Name") $ serviceRecip_name x
...
data ServiceRecipientAddress = ServiceRecipientAddress
        ...
        , serviceRecipAddress_postalCode :: Maybe Irct.String20
        , serviceRecipAddress_postOffice :: Maybe Irct.String200
        , serviceRecipAddress_countryCode :: Maybe Irct.String2
...
instance SchemaType ServiceRecipientAddress where
    ...
    schemaTypeToXML s x@ServiceRecipientAddress{} =
        toXMLElement s []
            ...
            , maybe [] (schemaTypeToXML "PostalCode") $ serviceRecipAddress_postalCode x
            , maybe [] (schemaTypeToXML "PostOffice") $ serviceRecipAddress_postOffice x
            , maybe [] (schemaTypeToXML "CountryCode") $ serviceRecipAddress_countryCode x
...
data SixMonthRule = SixMonthRule
        { sixMonthRule_applicable :: Maybe Irct.TrueOrFalse
...
instance SchemaType SixMonthRule where
    ...
    schemaTypeToXML s x@SixMonthRule{} =
        toXMLElement s []
            [ maybe [] (schemaTypeToXML "Applicable") $ sixMonthRule_applicable x
...
data StayPeriod = StayPeriod
        { stayPeriod_startDate :: Maybe Xsd.Date
        , stayPeriod_endDate :: Maybe Xsd.Date
        }
        deriving (Eq,Show)
instance SchemaType StayPeriod where
    ...
    schemaTypeToXML s x@StayPeriod{} =
        toXMLElement s []
            [ maybe [] (schemaTypeToXML "StartDate") $ stayPeriod_startDate x
            , maybe [] (schemaTypeToXML "EndDate") $ stayPeriod_endDate x
            ]
...
data SubstitutePayer = SubstitutePayer
        { substPayer_acts :: Maybe Irct.True
        , substPayer_employerId :: Maybe Id
...
instance SchemaType SubstitutePayer where
    parseSchemaType s = do
        ...
        commit $ interior e $ return SubstitutePayer
            `apply` optional (parseSchemaType "Acts")
            `apply` optional (parseSchemaType "EmployerId")
            `apply` optional (parseSchemaType "EmployerName")
            `apply` optional (parseSchemaType "WageSec")
    schemaTypeToXML s x@SubstitutePayer{} =
        toXMLElement s []
            [ maybe [] (schemaTypeToXML "Acts") $ substPayer_acts x
            , maybe [] (schemaTypeToXML "EmployerId") $ substPayer_employerId x
...
data TransactionInclusion = TransactionInclusion
        { transInclus_insuranceCode :: Maybe Xs.Int
        , transInclus_included :: Maybe Irct.TrueOrFalse
        }
        deriving (Eq,Show)
instance SchemaType TransactionInclusion where
    parseSchemaType s = do
        ...
        commit $ interior e $ return TransactionInclusion
            `apply` optional (parseSchemaType "InsuranceCode")
            `apply` optional (parseSchemaType "Included")
    schemaTypeToXML s x@TransactionInclusion{} =
        toXMLElement s []
            [ maybe [] (schemaTypeToXML "InsuranceCode") $ transInclus_insuranceCode x
            , maybe [] (schemaTypeToXML "Included") $ transInclus_included x
            ]
...
data TypedAddress = TypedAddress
        { typedAddress_addressType :: Maybe Xs.Int
        , typedAddress_co :: Maybe Irct.String70
        , typedAddress_street :: Maybe Irct.String100
        , typedAddress_pOBox :: Maybe Irct.String10
        , typedAddress_postalCode :: Maybe Irct.String20
        , typedAddress_postOffice :: Maybe Irct.String200
...
instance SchemaType TypedAddress where
    parseSchemaType s = do
        ...
        commit $ interior e $ return TypedAddress
            `apply` optional (parseSchemaType "AddressType")
            `apply` optional (parseSchemaType "Co")
            `apply` optional (parseSchemaType "Street")
            `apply` optional (parseSchemaType "POBox")
            `apply` optional (parseSchemaType "PostalCode")
    ...
    schemaTypeToXML s x@TypedAddress{} =
        toXMLElement s []
            [ maybe [] (schemaTypeToXML "AddressType") $ typedAddress_addressType x
            ...
            , maybe [] (schemaTypeToXML "PostalCode") $ typedAddress_postalCode x
            , maybe [] (schemaTypeToXML "PostOffice") $ typedAddress_postOffice x
...
data UnitWage = UnitWage
        { unitWage_unitPrice :: Maybe Irct.Decimal2
        , unitWage_unitAmount :: Maybe Irct.Decimal2
        , unitWage_unitCode :: Maybe Xs.Int
        }
        deriving (Eq,Show)
instance SchemaType UnitWage where
    ...
    schemaTypeToXML s x@UnitWage{} =
        toXMLElement s []
            [ maybe [] (schemaTypeToXML "UnitPrice") $ unitWage_unitPrice x
            , maybe [] (schemaTypeToXML "UnitAmount") $ unitWage_unitAmount x
            , maybe [] (schemaTypeToXML "UnitCode") $ unitWage_unitCode x
            ]
...
data UnpaidAbsencePeriod = UnpaidAbsencePeriod
        { unpaidAbsencePeriod_startDate :: Maybe Xsd.Date
        , unpaidAbsencePeriod_endDate :: Maybe Xsd.Date
        , unpaidAbsencePeriod_absenceDays :: Maybe Xs.Int
        , unpaidAbsencePeriod_causeCode :: Maybe Xs.Int
        }
        deriving (Eq,Show)
instance SchemaType UnpaidAbsencePeriod where
    ...
    schemaTypeToXML s x@UnpaidAbsencePeriod{} =
        toXMLElement s []
            [ maybe [] (schemaTypeToXML "StartDate") $ unpaidAbsencePeriod_startDate x
            ...
            , maybe [] (schemaTypeToXML "CauseCode") $ unpaidAbsencePeriod_causeCode x
            ]
...
data WageReportsFromIR = WageReportsFromIR
        { wageReportsFromIR_subscription :: Subscription
        , wageReportsFromIR_query :: Maybe Query
        , wageReportsFromIR_summary :: Summary
        , wageReportsFromIR_messageErrors :: Maybe Smt.MessageErrors
        , wageReportsFromIR_deliveryErrors :: Maybe Smt.DeliveryErrors
        , wageReportsFromIR_reports :: Maybe Reports
        , wageReportsFromIR_signature :: SignatureType
        }
        deriving (Eq,Show)
instance SchemaType WageReportsFromIR where
    parseSchemaType s = do
        (pos,e) <- posnElement [s]
        commit $ interior e $ return WageReportsFromIR
    ...
    schemaTypeToXML s x@WageReportsFromIR{} =
        toXMLElement s []
            [ schemaTypeToXML "Subscription" $ wageReportsFromIR_subscription x
            , maybe [] (schemaTypeToXML "Query") $ wageReportsFromIR_query x
            , schemaTypeToXML "Summary" $ wageReportsFromIR_summary x
            , maybe [] (schemaTypeToXML "MessageErrors") $ wageReportsFromIR_messageErrors x
            , maybe [] (schemaTypeToXML "DeliveryErrors") $ wageReportsFromIR_deliveryErrors x
            , maybe [] (schemaTypeToXML "Reports") $ wageReportsFromIR_reports x
            , elementToXMLSignature $ wageReportsFromIR_signature x
            ]
 
data WithdrawalPeriod = WithdrawalPeriod
        { withdrPeriod_startDate :: Maybe Xsd.Date
        , withdrPeriod_endDate :: Maybe Xsd.Date
        }
        deriving (Eq,Show)
instance SchemaType WithdrawalPeriod where
    ...
    schemaTypeToXML s x@WithdrawalPeriod{} =
        toXMLElement s []
            [ maybe [] (schemaTypeToXML "StartDate") $ withdrPeriod_startDate x
            , maybe [] (schemaTypeToXML "EndDate") $ withdrPeriod_endDate x
            ]
...
data WorkCountry = WorkCountry
        { workCountry_code :: Maybe Irct.String2
...
instance SchemaType WorkCountry where
    parseSchemaType s = do
        ...
        commit $ interior e $ return WorkCountry
            `apply` optional (parseSchemaType "WorkCountryCode")
    ...
    schemaTypeToXML s x@WorkCountry{} =
        toXMLElement s []
            [ maybe [] (schemaTypeToXML "WorkCountryCode") $ workCountry_code x
...
data WorkCountryAddress = WorkCountryAddress
        ...
        , workCountryAddress_postalCode :: Maybe Irct.String20
        , workCountryAddress_postOffice :: Maybe Irct.String200
        , workCountryAddress_countryCode :: Maybe Irct.String2
...
instance SchemaType WorkCountryAddress where
    ...
    schemaTypeToXML s x@WorkCountryAddress{} =
        toXMLElement s []
            ...
            , maybe [] (schemaTypeToXML "PostalCode") $ workCountryAddress_postalCode x
            , maybe [] (schemaTypeToXML "PostOffice") $ workCountryAddress_postOffice x
            , maybe [] (schemaTypeToXML "CountryCode") $ workCountryAddress_countryCode x
...
data WorkPeriodInFinland = WorkPeriodInFinland
        { workPeriodInFinland_startDate :: Maybe Xsd.Date
        , workPeriodInFinland_endDate :: Maybe Xsd.Date
