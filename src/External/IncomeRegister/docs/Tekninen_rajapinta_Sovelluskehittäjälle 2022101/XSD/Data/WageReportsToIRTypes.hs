...
module Data.WageReportsToIRTypes'xsd
  ( module Data.WageReportsToIRTypes'xsd
  ) where
...
data OrigPaymentPeriod = OrigPaymentPeriod
        ...
        , origPaymentPeriod_startDate :: Xsd.Date
        , origPaymentPeriod_endDate :: Xsd.Date
        }
        deriving (Eq,Show)
...
data PaidAbsencePeriod = PaidAbsencePeriod
        { paidAbsencePeriod_startDate :: Xsd.Date
...
data StayPeriod = StayPeriod
        { stayPeriod_startDate :: Xsd.Date
        , stayPeriod_endDate :: Xsd.Date
        }
        deriving (Eq,Show)
...
data UnpaidAbsencePeriod = UnpaidAbsencePeriod
        { unpaidAbsencePeriod_startDate :: Xsd.Date
...
data WithdrawalPeriod = WithdrawalPeriod
        { withdrPeriod_startDate :: Xsd.Date
        , withdrPeriod_endDate :: Xsd.Date
        }
        deriving (Eq,Show)
